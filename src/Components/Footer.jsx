...
const Footer = () => {
  return (
    ...
    <div id="contact" className="relative bg-[#000000] pt-28 md:pt-32 scroll-mt-24 overflow-x-clip"> 
      
      {/* --- FOOTER MAIN (Background #1F1F20) --- */}
      <footer className="relative bg-[#1F1F20] pt-24 md:pt-28 pb-6 px-6 font-['Urbanist'] overflow-visible">
        ...
        <motion.div 
          ...
          className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[92%] max-w-5xl bg-[#FD853A] rounded-[30px] md:rounded-[45px] p-6 md:p-10 flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl z-20"
        >
        ...
        {/* --- FOOTER GRID --- */}
        <div className="max-w-6xl mx-auto mt-8 md:mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 border-b border-white/5 pb-10">
